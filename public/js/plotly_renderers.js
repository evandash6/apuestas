(function() {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    return $.pivotUtilities.plotly_renderers = {
      "Gráfica Barras Horizontal": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'group'
      }, true),
      "Gráfica de Barras Horizontales Apiladas": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'relative'
      ...
      "Gráfica de Líneas": makePlotlyChart(),
      "Gráfica de Área": makePlotlyChart({
        stackgroup: 1
      }),
      // "Histo": makePlotlyChart({
      //   type: 'histogram'
      // },{
      //   histnorm: "count",
      //   barmode: 'relative'
      ...
      'Gráfica Multiple de Pastel': makePlotlyChart({
        type: 'pie',
        scalegroup: 1,
