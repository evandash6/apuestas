...
<script>
    ...
    let icons = function(cell, formatterParams){
        ...
        '<button ide="'+cell.getRow().getData().id+'" class="btx_marca btn btn-sm blue darken-1 mr-5"><i class="fa fa-check"></i></button>';
    };
    ...
    $('body').on('click','.btx_marca',function(){
        modal('Resultado',frm_mini,500)
    })
</script>